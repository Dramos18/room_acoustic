...
from Vista.barraTitulo import Ui_formBarraTitulo
...
class VentanaConBarra(QWidget):
    def __init__(self, contenido):
        ...
        # Ruta del logo
        pixmap = QPixmap("Vista/graficas/iconos/logoBN.png")
        ...
        self.uiBarra.buttonClose.setIcon(QIcon("Vista/graficas/iconos/cruz-pequena.png"))
        self.uiBarra.buttonClose.setIconSize(QSize(24, 24))
        self.uiBarra.buttonClose.setText("")  # Opcional

        self.uiBarra.buttonMinim.setIcon(QIcon("Vista/graficas/iconos/menos-pequeno.png"))
        self.uiBarra.buttonMinim.setIconSize(QSize(24, 24))
        self.uiBarra.buttonMinim.setText("")  # Opcional

        self.uiBarra.buttonMaxim.setIcon(QIcon("Vista/graficas/iconos/restaurar-ventana.png"))
