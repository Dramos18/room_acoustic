...
"}")
        ...
        self.logoBarraTitulo.setPixmap(QPixmap(u"estilos/iconos/logoBN.png"))
        ...
        icon = QIcon()
        icon.addFile(u"estilos/iconos/menos-pequeno.png", QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon1 = QIcon()
        icon1.addFile(u"estilos/iconos/restaurar-ventana.png", QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon2 = QIcon()
        icon2.addFile(u"estilos/iconos/cruz-pequena.png", QSize(), QIcon.Normal, QIcon.Off)
